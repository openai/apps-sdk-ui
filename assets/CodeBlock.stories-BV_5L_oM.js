import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{C as sr}from"./index-f1W-XCGd.js";import{C as a,a as R}from"./CodeBlock-BgCMP09Y.js";const tr={title:"Components/CodeBlock",component:a,parameters:{layout:"padded"},argTypes:{className:{control:!1},children:{control:!1},language:{control:{type:"select",options:["javascript","json","jsonc","python","bash","shell","sql","xml","typescript","jsx","tsx","c","clike","css","scss","diff","docker","go","java","kotlin","php","ruby","markdown","toml","yaml","markup"]}}}},o=e=>r.jsx(a,{...e});o.args={language:"js",children:`import OpenAI from "openai";
