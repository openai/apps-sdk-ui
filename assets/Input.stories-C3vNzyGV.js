import{j as e}from"./jsx-runtime-D_zvdyIk.js";import{r as Z}from"./index-CDlOlYQx.js";import"./index-f1W-XCGd.js";import{S as $,X as ee}from"./index-vTu4Yset.js";import{I as s}from"./index-mIpzE1Ic.js";import{B as b}from"./index-DSWOpmMK.js";const ae={title:"Components/Input",component:s,args:{placeholder:"Enter text...",allowAutofillExtensions:!1,disabled:!1,invalid:!1}},g=a=>e.jsx(s,{...a}),r=a=>{const[t,x]=Z.useState("");return e.jsxs("div",{className:"flex flex-col gap-2.5 justify-start items-start w-[220px]",children:[e.jsx(s,{...a}),e.jsx(s,{...a,placeholder:"Search...",startAdornment:e.jsx($,{className:"fill-tertiary"})}),e.jsx(s,{...a,value:t,placeholder:"Username",onChange:v=>x(v.target.value),maxLength:16,endAdornment:e.jsxs("span",{className:"mt-[1.5px] tabular-nums text-tertiary text-[.875em]",children:[t.length,"/16"]})})]})};r.args={size:"lg",pill:!1};r.parameters={controls:{include:["size","gutterSize","pill"]}};r.argTypes={size:{control:"select"},gutterSize:{control:"select"}};const o=a=>e.jsx(s,{...a});o.args={startAdornment:e.jsx($,{className:"fill-tertiary"}),placeholder:"Start adornment"};o.parameters={docs:{source:{code:`<Input
